    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          //
          // Bespoke surface/width/border rather than a SheetContent `size`/`surface` variant: the
          // sidebar owns its own token set (`--color-sidebar*`) and a `--sidebar-width` custom
          // property, neither of which belongs in the generic Sheet API. Grandfathered — don't copy
          // this shape into a new component; add a variant instead.
