...
export interface Proxy_factory extends BaseContract {
  ...
  createProxy: TypedContractMethod<[singleton: AddressLike, data: BytesLike], [string], 'nonpayable'>

  createProxyWithCallback: TypedContractMethod<
    [_singleton: AddressLike, initializer: BytesLike, saltNonce: BigNumberish, callback: AddressLike],
    [string],
    'nonpayable'
  >
