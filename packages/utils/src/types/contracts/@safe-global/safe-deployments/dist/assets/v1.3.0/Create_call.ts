...
export interface Create_call extends BaseContract {
  ...
  performCreate: TypedContractMethod<[value: BigNumberish, deploymentData: BytesLike], [string], 'nonpayable'>
  ...
  ): TypedContractMethod<[value: BigNumberish, deploymentData: BytesLike, salt: BytesLike], [string], 'nonpayable'>
