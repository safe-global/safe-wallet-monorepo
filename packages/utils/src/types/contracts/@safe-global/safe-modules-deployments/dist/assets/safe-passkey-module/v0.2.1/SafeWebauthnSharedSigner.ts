...
export interface SafeWebauthnSharedSignerInterface extends Interface {
  ...
  getEvent(nameOrSignatureOrTopic: 'SafeWebAuthnSharedSignerConfigured'): EventFragment

  encodeFunctionData(functionFragment: 'SIGNER_SLOT', values?: undefined): string
  encodeFunctionData(functionFragment: 'configure', values: [SafeWebAuthnSharedSigner.SignerStruct]): string
  ...
  decodeFunctionResult(functionFragment: 'SIGNER_SLOT', data: BytesLike): Result
...
export namespace SafeWebAuthnSharedSignerConfiguredEvent {
  export type InputTuple = [publicKeyHash: BytesLike, x: BigNumberish, y: BigNumberish, verifiers: BigNumberish]
  export type OutputTuple = [publicKeyHash: string, x: bigint, y: bigint, verifiers: bigint]
...
export interface SafeWebauthnSharedSigner extends BaseContract {
  ...
  configure: TypedContractMethod<[signer: SafeWebAuthnSharedSigner.SignerStruct], [void], 'nonpayable'>

  getConfiguration: TypedContractMethod<[account: AddressLike], [SafeWebAuthnSharedSigner.SignerStructOutput], 'view'>

  'isValidSignature(bytes32,bytes)': TypedContractMethod<[message: BytesLike, signature: BytesLike], [string], 'view'>

  'isValidSignature(bytes,bytes)': TypedContractMethod<[data: BytesLike, signature: BytesLike], [string], 'view'>

  getFunction<T extends ContractMethod = ContractMethod>(key: string | FunctionFragment): T

  getFunction(nameOrSignature: 'SIGNER_SLOT'): TypedContractMethod<[], [bigint], 'view'>
  getFunction(
    nameOrSignature: 'configure',
  ): TypedContractMethod<[signer: SafeWebAuthnSharedSigner.SignerStruct], [void], 'nonpayable'>
  getFunction(
    nameOrSignature: 'getConfiguration',
  ): TypedContractMethod<[account: AddressLike], [SafeWebAuthnSharedSigner.SignerStructOutput], 'view'>
  getFunction(
    nameOrSignature: 'isValidSignature(bytes32,bytes)',
  ): TypedContractMethod<[message: BytesLike, signature: BytesLike], [string], 'view'>
  getFunction(
    nameOrSignature: 'isValidSignature(bytes,bytes)',
  ): TypedContractMethod<[data: BytesLike, signature: BytesLike], [string], 'view'>
