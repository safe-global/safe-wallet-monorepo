...
export interface Safe4337ModuleInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: 'getOperationHash', values: [PackedUserOperationStruct]): string
...
export interface Safe4337Module extends BaseContract {
  ...
  getOperationHash: TypedContractMethod<[userOp: PackedUserOperationStruct], [string], 'view'>
  ...
  validateUserOp: TypedContractMethod<
    [userOp: PackedUserOperationStruct, arg1: BytesLike, missingAccountFunds: BigNumberish],
    [bigint],
    'nonpayable'
  >
