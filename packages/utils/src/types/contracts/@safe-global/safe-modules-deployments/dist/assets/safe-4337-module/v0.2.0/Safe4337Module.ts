...
export interface Safe4337ModuleInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: 'getOperationHash', values: [UserOperationStruct]): string
...
export interface Safe4337Module extends BaseContract {
  ...
  getOperationHash: TypedContractMethod<[userOp: UserOperationStruct], [string], 'view'>
  ...
  'isValidSignature(bytes,bytes)': TypedContractMethod<[_data: BytesLike, _signature: BytesLike], [string], 'view'>
  ...
  getFunction(nameOrSignature: 'getOperationHash'): TypedContractMethod<[userOp: UserOperationStruct], [string], 'view'>
  getFunction(
