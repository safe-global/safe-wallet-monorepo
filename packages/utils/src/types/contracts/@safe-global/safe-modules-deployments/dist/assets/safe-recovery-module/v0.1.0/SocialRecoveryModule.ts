...
export declare namespace SocialRecoveryModule {
  ...
  export type SignatureDataStructOutput = [signer: string, signature: string] & { signer: string; signature: string }
}
...
export interface SocialRecoveryModuleInterface extends Interface {
  ...
  encodeFunctionData(functionFragment: 'addGuardianWithThreshold', values: [AddressLike, BigNumberish]): string
  encodeFunctionData(functionFragment: 'cancelRecovery', values?: undefined): string
  ...
  encodeFunctionData(functionFragment: 'executeRecovery', values: [AddressLike, AddressLike[], BigNumberish]): string
  encodeFunctionData(functionFragment: 'finalizeRecovery', values: [AddressLike]): string
  encodeFunctionData(functionFragment: 'getChainId', values?: undefined): string
  encodeFunctionData(functionFragment: 'getGuardians', values: [AddressLike]): string
  encodeFunctionData(
  ...
  encodeFunctionData(functionFragment: 'getRecoveryRequest', values: [AddressLike]): string
  encodeFunctionData(functionFragment: 'guardiansCount', values: [AddressLike]): string
  encodeFunctionData(
  ...
  encodeFunctionData(
    ...
    values: [AddressLike, AddressLike[], BigNumberish, SocialRecoveryModule.SignatureDataStruct[], boolean],
  ): string
  ...
  encodeFunctionData(functionFragment: 'threshold', values: [AddressLike]): string
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: 'addGuardianWithThreshold', data: BytesLike): Result
  ...
  decodeFunctionResult(functionFragment: 'confirmRecovery', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'domainSeparator', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'encodeRecoveryData', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'executeRecovery', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'finalizeRecovery', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'getChainId', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'getGuardians', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'getRecoveryApprovals', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'getRecoveryHash', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'getRecoveryRequest', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'guardiansCount', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'hasGuardianApproved', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'invalidateNonce', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'isGuardian', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'multiConfirmRecovery', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'nonce', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'revokeGuardianWithThreshold', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'threshold', data: BytesLike): Result
  decodeFunctionResult(functionFragment: 'validateGuardianSignature', data: BytesLike): Result
}
...
export namespace RecoveryFinalizedEvent {
  ...
  export type OutputTuple = [wallet: string, newOwners: string[], newThreshold: bigint, nonce: bigint]
  export interface OutputObject {
    wallet: string
    newOwners: string[]
    newThreshold: bigint
...
export interface SocialRecoveryModule extends BaseContract {
  ...
  confirmRecovery: TypedContractMethod<
    [_wallet: AddressLike, _newOwners: AddressLike[], _newThreshold: BigNumberish, _execute: boolean],
    [void],
    'nonpayable'
  >
  ...
  encodeRecoveryData: TypedContractMethod<
    [_wallet: AddressLike, _newOwners: AddressLike[], _newThreshold: BigNumberish, _nonce: BigNumberish],
    [string],
    'view'
  >

  executeRecovery: TypedContractMethod<
    [_wallet: AddressLike, _newOwners: AddressLike[], _newThreshold: BigNumberish],
    [void],
    'nonpayable'
  >

  finalizeRecovery: TypedContractMethod<[_wallet: AddressLike], [void], 'nonpayable'>
  ...
  hasGuardianApproved: TypedContractMethod<
    [_wallet: AddressLike, _guardian: AddressLike, _newOwners: AddressLike[], _newThreshold: BigNumberish],
    [boolean],
    'view'
  >
  ...
  isGuardian: TypedContractMethod<[_wallet: AddressLike, _guardian: AddressLike], [boolean], 'view'>
  ...
  revokeGuardianWithThreshold: TypedContractMethod<
    [_prevGuardian: AddressLike, _guardian: AddressLike, _threshold: BigNumberish],
    [void],
    'nonpayable'
  >
  ...
  validateGuardianSignature: TypedContractMethod<
    [_wallet: AddressLike, _signHash: BytesLike, _signer: AddressLike, _signature: BytesLike],
    [void],
    'view'
  >
  ...
  ): TypedContractMethod<[_guardian: AddressLike, _threshold: BigNumberish], [void], 'nonpayable'>
  getFunction(nameOrSignature: 'cancelRecovery'): TypedContractMethod<[], [void], 'nonpayable'>
  ...
  getFunction(
    ...
    'nonpayable'
  >
  getFunction(nameOrSignature: 'finalizeRecovery'): TypedContractMethod<[_wallet: AddressLike], [void], 'nonpayable'>
  getFunction(nameOrSignature: 'getChainId'): TypedContractMethod<[], [bigint], 'view'>
  getFunction(nameOrSignature: 'getGuardians'): TypedContractMethod<[_wallet: AddressLike], [string[]], 'view'>
  getFunction(
  ...
  ): TypedContractMethod<[_wallet: AddressLike], [SocialRecoveryModule.RecoveryRequestStructOutput], 'view'>
  getFunction(nameOrSignature: 'guardiansCount'): TypedContractMethod<[_wallet: AddressLike], [bigint], 'view'>
  getFunction(
    ...
    'view'
  >
  getFunction(nameOrSignature: 'invalidateNonce'): TypedContractMethod<[], [void], 'nonpayable'>
  getFunction(
    nameOrSignature: 'isGuardian',
  ): TypedContractMethod<[_wallet: AddressLike, _guardian: AddressLike], [boolean], 'view'>
  getFunction(
    ...
    'nonpayable'
  >
  getFunction(nameOrSignature: 'nonce'): TypedContractMethod<[_wallet: AddressLike], [bigint], 'view'>
  getFunction(
    ...
    'nonpayable'
  >
  getFunction(nameOrSignature: 'threshold'): TypedContractMethod<[_wallet: AddressLike], [bigint], 'view'>
  getFunction(
  ...
  getEvent(
    key: 'GuardianAdded',
  ): TypedContractEvent<GuardianAddedEvent.InputTuple, GuardianAddedEvent.OutputTuple, GuardianAddedEvent.OutputObject>
  getEvent(
    key: 'GuardianRevoked',
  ): TypedContractEvent<
