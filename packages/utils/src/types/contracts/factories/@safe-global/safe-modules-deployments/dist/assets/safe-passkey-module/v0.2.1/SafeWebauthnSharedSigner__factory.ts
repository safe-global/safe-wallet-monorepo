...
export class SafeWebauthnSharedSigner__factory {
  ...
  static connect(address: string, runner?: ContractRunner | null): SafeWebauthnSharedSigner {
    return new Contract(address, _abi, runner) as unknown as SafeWebauthnSharedSigner
  }
}
