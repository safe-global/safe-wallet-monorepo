...
| `NEXT_PUBLIC_WC_METADATA_URL`                     | URL advertised in the WalletConnect peer metadata. Should match the page origin to avoid metadata-mismatch warnings. Defaults to `https://app.safe.global`              |
| `NEXT_PUBLIC_WC_METADATA_ICONS`                   | Comma-separated icon URLs advertised in the WalletConnect peer metadata. Defaults to `${NEXT_PUBLIC_WC_METADATA_URL}/images/logo-round.svg`                             |
