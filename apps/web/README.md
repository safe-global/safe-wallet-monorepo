...
| `NEXT_PUBLIC_AUTH0_DOMAIN`                    | [Auth0](https://auth0.com) tenant domain for email-based authentication (e.g. `your-tenant.auth0.com`)                                                                                                                                      |
| `NEXT_PUBLIC_AUTH0_CLIENT_ID`                 | Auth0 application client ID                                                                                                                                                                                                                 |
| `NEXT_PUBLIC_AUTH0_AUDIENCE`                  | Auth0 API audience identifier used to request scoped access tokens (e.g. `https://safe-client.staging.5afe.dev/api`)                                                                                                                        |
