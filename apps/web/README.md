...
| `NEXT_PUBLIC_TURNSTILE_TEST_SITE_KEY`         | (Optional) Test site key for development. Overrides `NEXT_PUBLIC_TURNSTILE_SITE_KEY` if set. Use test keys like `3x00000000000000000000FF` to force interactive challenges. See [Cloudflare Turnstile testing docs](https://developers.cloudflare.com/ |
