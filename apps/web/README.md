...
| `NEXT_PUBLIC_HYPERNATIVE_AUTH_URL`           | [Hypernative](https://hypernative.io) OAuth authorization endpoint. Defaults to mock endpoint for development. Production: `https://api.hypernative.xyz/oauth/authorize`                      |
| `NEXT_PUBLIC_HYPERNATIVE_TOKEN_URL`          | Hypernative OAuth token exchange endpoint. Defaults to mock endpoint for development. Production: `https://api.hypernative.xyz/oauth/token`                                                   |
| `NEXT_PUBLIC_HYPERNATIVE_API_URL`            | Hypernative API base URL for threat analysis. Defaults to mock endpoint for development. Production: `https://api.hypernative.xyz`                                                            |
| `NEXT_PUBLIC_HYPERNATIVE_CLIENT_ID`          | Hypernative OAuth client ID. Defaults to `SAFE_WALLET_SPA` for production                                                                                                                     |
