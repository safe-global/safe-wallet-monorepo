...
const customJestConfig = {
  ...
  // Exclude storybook snapshot tests and Playwright specs from main test run - they have their own CI workflows
  testPathIgnorePatterns: ['/node_modules/', '/.next/', '/playwright/', '\\.stories\\.test\\.tsx$'],
}
