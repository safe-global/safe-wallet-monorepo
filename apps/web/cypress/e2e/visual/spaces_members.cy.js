...
describe('[VISUAL] Spaces members screenshots', { defaultCommandTimeout: 60000, ...constants.VISUAL_VIEWPORT }, () => {
  beforeEach(() => {
    signInToSpaces()
  ...
  it('[VISUAL] Screenshot spaces members pending tab', () => {
    space.clickMembersPendingTab()
    main.awaitVisualStability()
  })
})
