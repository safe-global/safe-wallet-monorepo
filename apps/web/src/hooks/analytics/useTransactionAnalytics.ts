...
export const useTransactionAnalytics = () => {
  ...
  const trackTransactionConfirmed = useCallback(
    (params: TransactionAnalyticsParams) => {
      track({
  ...
  const trackTransactionExecuted = useCallback(
    (params: TransactionAnalyticsParams) => {
      track({
  ...
  const trackTokenTransfer = useCallback(
  ...
  const trackNftTransfer = useCallback(
  ...
  const trackBatchTransaction = useCallback(
    (txCount: number) => {
      trackTransactionCreated({
        txType: 'batch',
  ...
  const trackSwapTransaction = useCallback(
    (inputAmount: string, inputToken: string, outputToken: string) => {
      trackTransactionCreated({
        txType: 'native_swap',
        amount: inputAmount,
  ...
  const trackSpeedUpTransaction = useCallback(
    (txType: string) => {
