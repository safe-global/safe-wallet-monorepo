...
// MixPanel
export const PROD_MIXPANEL_TOKEN = process.env.NEXT_PUBLIC_PROD_MIXPANEL_TOKEN || ''
export const TEST_MIXPANEL_TOKEN = process.env.NEXT_PUBLIC_TEST_MIXPANEL_TOKEN || ''
export const MIXPANEL_TOKEN = IS_PRODUCTION ? PROD_MIXPANEL_TOKEN : TEST_MIXPANEL_TOKEN
