...
describe('useCompatibilityWarning', () => {
  ...
  describe('should return a warning for a risky bridge', () => {
    it('if the dApp is named', () => {
      ...
      expect(result.current).toEqual({
        message:
          'While bridging via Fake Bridge, please make sure that the destination address you send funds to matches the Safe address you have on the respective chain. Otherwise, the funds will be lost.',
        severity: 'warning',
      })
    })
    ...
    it('if the dApp is not named', () => {
      ...
      expect(result.current).toEqual({
        message:
          'While bridging via this dApp, please make sure that the destination address you send funds to matches the Safe address you have on the respective chain. Otherwise, the funds will be lost.',
        severity: 'warning',
      })
    })
  })
