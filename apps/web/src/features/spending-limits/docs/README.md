...
- **Test chains** offer both sets (M1 Policies decision Q52): the short periods keep reset behaviour testable in one session, the production periods keep daily / weekly / monthly verifiable on Sepolia. Both apply to the Safe-level and the Workspace policy flows.
