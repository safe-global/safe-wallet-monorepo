...
// No divider: the panel is delimited by its own `--sidebar` surface colour against the page. `ring-0`
// cancels the floating variant's ring in ui/sidebar.tsx so no edge returns. Radius is dev's 12px.
