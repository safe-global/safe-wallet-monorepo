...
const SafeDropdownContainer = ({ items, selectedItemId }: SafeDropdownContainerProps) => {
  ...
  return (
    <SelectContent
      ...
      className="w-[430px] max-w-[calc(100vw-2rem)] max-h-[14rem] overflow-y-auto bg-card border-0 ring-0 rounded-3xl px-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden"
      sideOffset={20}
      alignOffset={9}
