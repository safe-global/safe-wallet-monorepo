    ...
    <>
      <Tooltip title="Edit contact" placement="top">
        <IconButton onClick={(e) => handleOpenModal(e, ModalType.EDIT)} size="small">
          <SvgIcon component={EditIcon} inheritViewBox fontSize="small" sx={{ color: 'var(--color-border-main)' }} />
        </IconButton>
      </Tooltip>
      ...
      {open[ModalType.REMOVE] && (
        <ModalDialog open onClose={handleCloseModal} dialogTitle="Delete contact" hideChainIndicator>
          ...
          <DialogActions>
            ...
            <Button data-testid="delete-btn" variant="contained" color="error" onClick={handleRemove} disableElevation>
              Delete
            </Button>
          </DialogActions>
        </ModalDialog>
