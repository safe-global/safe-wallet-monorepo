  ...
  return (
    <div className={cn('shadcn-scope', isDarkMode && 'dark')}>
      <div className={cn('flex h-dvh w-full overflow-hidden bg-background p-4', className)}>
        <main className="flex h-full w-full flex-col overflow-hidden bg-background p-4 sm:p-8 lg:w-1/3">
        ...
        <aside className="hidden h-full w-2/3 overflow-hidden rounded-3xl bg-muted lg:flex">{sidePanel}</aside>
      </div>
    </div>
  )
}
