...
export const UnnamedAccounts: Story = {
  args: {
    content: {
      ...
      overview: { ...OVERVIEW, appliesTo: { address: SAFE.address } },
    },
  },
}
