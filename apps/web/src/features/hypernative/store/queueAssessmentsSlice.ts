...
export const queueAssessmentsSlice = createSlice({
  name: 'queueAssessments',
  initialState,
  reducers: {
    setAssessment: (
      state,
...
export const { setAssessment, setBatchAssessments, clearAssessments, removeAssessment } = queueAssessmentsSlice.actions

export const selectQueueAssessments = (state: RootState): QueueAssessmentsState =>
  state[queueAssessmentsSlice.name] || initialState
