...
[5.12. Fingerprint](#fingerprint)

[5.13. Auth0 by Okta](#auth0-by-okta)
...
This tool enables the login via Single Sign-On as described in section (3.1.2). Email addresses are not stored by SafeLabs but by Auth0. SafeLabs only processes the User ID generated by Auth0 tied to the user email.
