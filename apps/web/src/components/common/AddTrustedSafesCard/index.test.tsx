...
describe('AddTrustedSafesCard', () => {
  it('renders the add-trusted CTA', () => {
    render(<AddTrustedSafesCard onAdd={jest.fn()} />)

    expect(screen.getByText('Add trusted Safes')).toBeInTheDocument()
    expect(screen.getByTestId('add-trusted-safes-button')).toBeInTheDocument()
  })
