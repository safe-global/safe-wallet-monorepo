...
// Revealed on row hover (`group/row`) and focus. group-focus-visible, not group-focus: base-ui parks focus
// on the last hovered option, so plain focus would keep actions visible.
