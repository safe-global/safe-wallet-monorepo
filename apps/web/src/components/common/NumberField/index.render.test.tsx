...
describe('NumberField rendering', () => {
  it('passes inputSize and variant to a plain input', () => {
    const { container } = render(<NumberField label="Amount" inputSize="hero" variant="surface" />)
  ...
  it('passes inputSize and variant to an adorned input group', () => {
    const { container } = render(
      <NumberField aria-label="Amount" startAdornment="$" inputSize="hero" variant="surface" />,
    )
