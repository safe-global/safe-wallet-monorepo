...
export const DisableSafenetFlow = dynamic(() => import('@/features/safenet/components/tx-flow/DisableSafenet'))
export const EnableSafenetFlow = dynamic(() => import('@/features/safenet/components/tx-flow/EnableSafenet'))
...
export const SafenetTokenTransfersFlow = dynamic(
  () => import('@/features/safenet/components/tx-flow/SafenetTokenTransfers'),
)
