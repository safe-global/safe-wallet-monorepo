...
/** No assets yet — just the name field and the "Fund new asset" button. */
export const Empty: Story = {
  decorators: [withTxFlowContext({ name: '', assets: [] }), defaultSetup.decorator],
}

/** One funded asset, using the same `TokenAmountInput` as the Send flow. */
...
/** Two funded assets — each row excludes the token the other has picked. */
