    ...
    <div style={{ display: 'block' }}>
      ...
      <div>
        ...
        >
          ...
          <AlertDialog>
            <AlertDialogTrigger render={<Button variant="destructive">Delete with action</Button>} />
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogTitle>Are you sure?</AlertDialogTitle>
                <AlertDialogDescription>
          ...
          <AlertDialog>
            <AlertDialogTrigger render={<Button>With media</Button>} />
            <AlertDialogContent>
              <AlertDialogHeader>
                <AlertDialogMedia>
                ...
                <AlertDialogDescription>This dialog uses the media slot to show an icon.</AlertDialogDescription>
              </AlertDialogHeader>
              <AlertDialogFooter>
                <AlertDialogCancel>Cancel</AlertDialogCancel>
                <AlertDialogAction>Continue</AlertDialogAction>
