        ...
        <TooltipPrimitive.Popup
          ...
          className={cn(
            /* The tooltip is the app's only inverted text surface, so it owns what a link looks like on
               ...
               the affordance. `:not([data-slot=button])` leaves `ExternalLink mode="button"` alone. */
            '[&_a:not([data-slot=button])]:text-background [&_a:not([data-slot=button])]:underline [&_a:not([data-slot=button])]:decoration-background/60 [&_a:not([data-slot=button])]:hover:decoration-current',
