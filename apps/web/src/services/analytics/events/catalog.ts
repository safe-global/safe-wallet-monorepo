...
export const EventSchemas = {
    ...
    transaction_executed: z.object({
        ...
        safe_address: z.string(),
        chain_id: z.string(),
        execution_method: z.enum(['standard', 'speed_up', 'via_spending_limit', 'via_role', 'via_parent', 'in_parent']).optional(),
    }),
    ...
    safe_app_interaction: z.object({
        app_name: z.string(),
        app_url: z.string(),
        action: z.enum(['pin', 'unpin', 'copy_share_url', 'search', 'add_custom_app', 'open_transaction_modal', 'propose_transaction']),
        safe_address: z.string(),
        chain_id: z.string(),
    }),
 ...
 */
export const createEvent = <E extends EventMap = EventMap>() =>
    <K extends EventName>(
        name: K,
        payload: E[K],
        context?: import('../core/types').EventContext
