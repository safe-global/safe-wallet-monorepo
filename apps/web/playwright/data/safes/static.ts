/**
 * Static Safe addresses for Playwright E2E tests.
 *
 * Ported from cypress/fixtures/safes/static.js — same addresses, now typed.
...
export type StaticSafes = typeof staticSafes
export type StaticSafeKey = keyof StaticSafes

export default staticSafes
