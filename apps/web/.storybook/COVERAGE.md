...
> Last updated: 2026-08-18T10:00:47.243Z
...
| Metric                 | Value     |
| ---------------------- | --------- |
| Total Top-Level Groups | 52        |
| Covered Groups         | 41 (79%)  |
| Total Families         | 738       |
| Covered Families       | 650 (88%) |
| Total Components       | 1122      |
| Components Covered     | 973 (87%) |
| Total Story Exports    | 714       |

---

## 1. Top-Level Coverage (52 groups)
...
| Assets              | balance     | 1        | 1          | (family stories)                           | 4       | ✅     |
| Balances            | balance     | 7        | 15         | (family stories)                           | 11      | ✅     |
| Batching            | other       | 2        | 5          | (family stories)                           | 5       | ✅     |
| Bridge              | other       | 2        | 2          | (family stories)                           | 1       | ✅     |
| Common              | common      | 123      | 159        | (family stories)                           | 195     | ✅     |
| Counterfactual      | other       | 10       | 10         | (family stories)                           | 5       | ✅     |
| Dashboard           | dashboard   | 10       | 17         | (family stories)                           | 27      | ✅     |
| Earn                | other       | 11       | 11         | (family stories)                           | 6       | ✅     |
| Global-search       | other       | 6        | 10         | (family stories)                           | 18      | ✅     |
| Gtf                 | other       | 4        | 4          | (family stories)                           | 15      | ✅     |
| Hypernative         | other       | 22       | 34         | (family stories)                           | 10      | ✅     |
| Ledger              | other       | 1        | 1          | (family stories)                           | 3       | ✅     |
| Multichain          | other       | 7        | 8          | (family stories)                           | 14      | ✅     |
| MyAccounts          | other       | 23       | 42         | (family stories)                           | 40      | ✅     |
| Nested-safes        | other       | 4        | 7          | (family stories)                           | 9       | ✅     |
| Nfts                | other       | 5        | 5          | (family stories)                           | 4       | ✅     |
| No-fee-campaign     | other       | 3        | 3          | (family stories)                           | 3       | ✅     |
| Notification-center | other       | 4        | 4          | (family stories)                           | 4       | ✅     |
| Oidc-auth           | other       | 7        | 8          | (family stories)                           | 9       | ✅     |
| Portfolio           | other       | 1        | 1          | (family stories)                           | 7       | ✅     |
| Positions           | other       | 8        | 8          | (family stories)                           | 5       | ✅     |
| Recovery            | other       | 21       | 26         | (family stories)                           | 4       | ✅     |
| Safe-apps           | other       | 21       | 34         | (family stories)                           | 11      | ✅     |
| Safe-overview       | other       | 2        | 2          | `features/safe-overview/index.stories.tsx` | 2       | ✅     |
| Settings            | settings    | 21       | 27         | (family stories)                           | 14      | ✅     |
| Spaces              | other       | 77       | 180        | (family stories)                           | 81      | ✅     |
| Speedup             | other       | 2        | 2          | (family stories)                           | 3       | ✅     |
| Spending-limits     | other       | 7        | 10         | (family stories)                           | 12      | ✅     |
| Stake               | other       | 5        | 6          | (family stories)                           | 10      | ✅     |
| Support-chat        | other       | 1        | 1          | (family stories)                           | 2       | ✅     |
| Swap                | other       | 12       | 16         | (family stories)                           | 9       | ✅     |
| Targeted-outreach   | other       | 1        | 1          | (family stories)                           | 1       | ✅     |
| Transactions        | transaction | 53       | 69         | (family stories)                           | 35      | ✅     |
| Transactions        | transaction | 1        | 1          | (family stories)                           | 3       | ✅     |
| Tx                  | transaction | 35       | 54         | (family stories)                           | 27      | ✅     |
| Tx-flow             | other       | 60       | 115        | (family stories)                           | 8       | ✅     |
| Tx-notes            | other       | 3        | 3          | (family stories)                           | 3       | ✅     |
| Ui                  | ui          | 52       | 52         | (family stories)                           | 84      | ✅     |
| Wallet              | other       | 1        | 1          | (family stories)                           | 2       | ✅     |
| Walletconnect       | other       | 13       | 17         | (family stories)                           | 6       | ✅     |

### ❌ Uncovered Groups (8)

| Group                  | Category | Families | Components | Action Needed                                              |
| ---------------------- | -------- | -------- | ---------- | ---------------------------------------------------------- |
| Address-book           | other    | 3        | 3          | Create `components/address-book/index.stories.tsx`         |
| Feature-flag-overrides | other    | 2        | 5          | Create `features/feature-flag-overrides/index.stories.tsx` |
| Mocks                  | other    | 1        | 1          | Create `stories/mocks/index.stories.tsx`                   |
| New-safe               | other    | 19       | 22         | Create `components/new-safe/index.stories.tsx`             |
| Proposers              | other    | 1        | 7          | Create `features/proposers/index.stories.tsx`              |
| Safe-messages          | other    | 14       | 15         | Create `components/safe-messages/index.stories.tsx`        |
| Safe-shield            | other    | 13       | 25         | Create `features/safe-shield/index.stories.tsx`            |
| Welcome                | other    | 1        | 1          | Create `components/welcome/index.stories.tsx`              |
...
## 2. Family Coverage (738 families)
...
<details>
<summary>📁 Address-book (3 families, 3 components) - ❌ 0/3 covered, 0 exports</summary>

| Family       | Path                                 | Components | Story | Exports |
| ------------ | ------------------------------------ | ---------- | ----- | ------- |
| EntryDialog  | components/address-book/EntryDialog  | 1          | —     | —       |
| ImportDialog | components/address-book/ImportDialog | 1          | —     | —       |
| RemoveDialog | components/address-book/RemoveDialog | 1          | —     | —       |

</details>

<details>
<summary>📁 Assets (1 families, 1 components) - ✅ 1/1 covered (1 with own stories), 8 exports</summary>

| Family     | Path                                  | Components | Story               | Exports                       |
| ---------- | ------------------------------------- | ---------- | ------------------- | ----------------------------- |
| AssetsList | features/assets/components/AssetsList | 1          | `index.stories.tsx` | Default, Loading, NoAssets... |
...
<details>
<summary>📁 Batching (2 families, 5 components) - ✅ 2/2 covered (2 with own stories), 10 exports</summary>

| Family       | Path                                      | Components | Story                     | Exports                                          |
| ------------ | ----------------------------------------- | ---------- | ------------------------- | ------------------------------------------------ |
| BatchSidebar | features/batching/components/BatchSidebar | 4          | `BatchTxItem.stories.tsx` | Loading, NamedContractInteraction, TokenTransfer |
| BatchTooltip | features/batching/components/BatchTooltip | 1          | `index.stories.tsx`       | Default, Shown                                   |

</details>

<details>
<summary>📁 Bridge (2 families, 2 components) - ✅ 2/2 covered (1 with own stories), 2 exports</summary>

| Family       | Path                                    | Components | Story               | Exports |
| ------------ | --------------------------------------- | ---------- | ------------------- | ------- |
| Bridge       | features/bridge/components/Bridge       | 1          | ↑ group (Bridge)    | —       |
| BridgeWidget | features/bridge/components/BridgeWidget | 1          | `index.stories.tsx` | Default |

</details>

<details>
<summary>📁 Common (123 families, 159 components) - ✅ 123/123 covered (51 with own stories), 390 exports</summary>

| Family                     | Path                                         | Components | Story                                 | Exports                                        |
| -------------------------- | -------------------------------------------- | ---------- | ------------------------------------- | ---------------------------------------------- |
| AccountBadges              | components/common/AccountBadges              | 1          | `AccountBadges.stories.tsx`           | Pending, PendingCompact, Threshold...          |
| AccountRow                 | components/common/AccountRow                 | 7          | ↑ group (Common)                      | —                                              |
| ActionBar                  | components/common/ActionBar                  | 1          | `ActionBar.stories.tsx`               | AllVariants                                    |
| ActionCard                 | components/common/ActionCard                 | 1          | `ActionCard.stories.tsx`              | CriticalSeverity, InfoSeverity, LongContent... |
| AddAccountsChooser         | components/common/AddAccountsChooser         | 1          | `AddAccountsChooser.stories.tsx`      | Default, Secondary                             |
| AddFunds                   | components/common/AddFunds                   | 1          | ↑ group (Common)                      | —                                              |
| AddressBookInput           | components/common/AddressBookInput           | 3          | `AddressBookInput.stories.tsx`        | UnknownAddress, WithContacts                   |
...
| AddTrustedSafesCard        | components/common/AddTrustedSafesCard        | 1          | `AddTrustedSafesCard.stories.tsx`     | Default                                        |
...
| ChooserRow                 | components/common/ChooserRow                 | 1          | ↑ group (Common)                      | —                                              |
...
| DialogActions              | components/common/DialogActions              | 1          | `DialogActions.stories.tsx`           | AllVariants                                    |
...
| ErrorDetails               | components/common/ErrorDetails               | 1          | ↑ group (Common)                      | —                                              |
...
| FiatBalance                | components/common/FiatBalance                | 1          | ↑ group (Common)                      | —                                              |
...
| IconAction                 | components/common/IconAction                 | 1          | `IconAction.stories.tsx`              | AllVariants                                    |
...
| Notifications              | components/common/Notifications              | 1          | `Notifications.stories.tsx`           | AllVariants, Default, WithDetailedMessage...   |
...
| OnboardingFooter           | components/common/OnboardingFooter           | 1          | `OnboardingFooter.stories.tsx`        | AllVariants                                    |
...
| SpaceSafeBar               | components/common/SpaceSafeBar               | 3          | `SpaceChainSelector.stories.tsx`      | MultiChain, SingleChain                        |
...
| SubmitButton               | components/common/SubmitButton               | 1          | `SubmitButton.stories.tsx`            | AllVariants                                    |
...
| TrustedSafesModal          | components/common/TrustedSafesModal          | 5          | `SimilarityConfirmDialog.stories.tsx` | HighRisk, WithName                             |
...
| WelcomeContentCard         | components/common/WelcomeContentCard         | 1          | ↑ group (Common)                      | —                                              |
| WidgetDisclaimer           | components/common/WidgetDisclaimer           | 1          | ↑ group (Common)                      | —                                              |

</details>

<details>
<summary>📁 Counterfactual (10 families, 10 components) - ✅ 10/10 covered (2 with own stories), 10 exports</summary>
...
| CheckBalance                | features/counterfactual/components/CheckBalance                | 1          | `CheckBalance.stories.tsx`   | Default                                  |
...
| PayNowPayLater              | features/counterfactual/components/PayNowPayLater              | 1          | `PayNowPayLater.stories.tsx` | Default, MultiChain, NotAuthenticated... |
...
<details>
<summary>📁 Feature-flag-overrides (2 families, 5 components) - ❌ 0/2 covered, 0 exports</summary>

| Family                 | Path                                       | Components | Story | Exports |
| ---------------------- | ------------------------------------------ | ---------- | ----- | ------- |
| Components             | features/feature-flag-overrides/components | 4          | —     | —       |
| Feature-flag-overrides | features/feature-flag-overrides            | 1          | —     | —       |

</details>

<details>
<summary>📁 Global-search (6 families, 10 components) - ✅ 6/6 covered (6 with own stories), 36 exports</summary>

| Family            | Path                                                                  | Components | Story                             | Exports                                |
| ----------------- | --------------------------------------------------------------------- | ---------- | --------------------------------- | -------------------------------------- |
| Accounts          | features/global-search/components/SearchSection/sections/Accounts     | 1          | `AccountsSection.stories.tsx`     | FilteredByQuery, Loading, NoResults... |
| GlobalSearchInput | features/global-search/components/GlobalSearchInput                   | 1          | `index.stories.tsx`               | Constrained, Default                   |
| GlobalSearchModal | features/global-search/components/GlobalSearchModal                   | 3          | `GlobalSearch.stories.tsx`        | Empty, Interactive, WithValue          |
| NavigateTo        | features/global-search/components/SearchSection/sections/NavigateTo   | 1          | `NavigateToSection.stories.tsx`   | Default, Disconnected, FilteredQuery   |
| SearchSection     | features/global-search/components/SearchSection                       | 3          | `SearchSection.stories.tsx`       | Default, NoResults, WithQuery          |
| TrustedSafes      | features/global-search/components/SearchSection/sections/TrustedSafes | 1          | `TrustedSafesSection.stories.tsx` | FilteredByQuery, NoMatches, Populated  |
...
<details>
<summary>📁 Multichain (7 families, 8 components) - ✅ 7/7 covered (3 with own stories), 28 exports</summary>

| Family                   | Path                                                    | Components | Story                           | Exports                                                          |
| ------------------------ | ------------------------------------------------------- | ---------- | ------------------------------- | ---------------------------------------------------------------- |
| CreateSafeOnNewChain     | features/multichain/components/CreateSafeOnNewChain     | 1          | ↑ group (Multichain)            | —                                                                |
| MastercopyWarning        | features/multichain/components/MastercopyWarning        | 1          | `MastercopyWarning.stories.tsx` | Cli, Migrate, None...                                            |
| NetworkLogosList         | features/multichain/components/NetworkLogosList         | 1          | `NetworkLogosList.stories.tsx`  | FourNetworks, InsideAccountBadgePill, ManyNetworksWithHasMore... |
| NetworkLogosPill         | features/multichain/components/NetworkLogosPill         | 1          | `NetworkLogosPill.stories.tsx`  | FewNetworks, WithOverflow                                        |
| NetworkLogosTooltip      | features/multichain/components/NetworkLogosTooltip      | 1          | ↑ group (Multichain)            | —                                                                |
...
<details>
<summary>📁 MyAccounts (23 families, 42 components) - ✅ 23/23 covered (8 with own stories), 80 exports</summary>
...
| AccountsWidget         | features/myAccounts/components/AccountsWidget                                 | 1          | `AccountsWidget.stories.tsx`         | Default, Empty, Error...                                       |
...
| GetStartedCard         | features/myAccounts/components/MyAccountsV2/components/GetStartedCard         | 1          | `GetStartedCard.stories.tsx`         | Default                                                        |
...
| SafeAccountsTable      | features/myAccounts/components/SafeAccountsTable                              | 5          | `SafeAccountsTable.stories.tsx`      | Default, Empty, NameAndBalanceOnly...                          |
| SafesList              | features/myAccounts/components/SafesList                                      | 2          | ↑ group (MyAccounts)                 | —                                                              |
| TrustedAccountsActions | features/myAccounts/components/MyAccountsV2/components/TrustedAccountsActions | 1          | `TrustedAccountsActions.stories.tsx` | Default                                                        |

</details>

<details>
<summary>📁 Nested-safes (4 families, 7 components) - ✅ 4/4 covered (4 with own stories), 18 exports</summary>

| Family             | Path                                       | Components | Story               | Exports                                   |
| ------------------ | ------------------------------------------ | ---------- | ------------------- | ----------------------------------------- |
| NestedSafeInfo     | components/nested-safes/NestedSafeInfo     | 1          | `index.stories.tsx` | Default                                   |
| NestedSafeIntro    | components/nested-safes/NestedSafeIntro    | 1          | `index.stories.tsx` | Default                                   |
| NestedSafesList    | components/nested-safes/NestedSafesList    | 4          | `index.stories.tsx` | Default, ManageMode, WithSimilarityGroups |
| NestedSafesPopover | components/nested-safes/NestedSafesPopover | 1          | `index.stories.tsx` | Empty, FirstTimeCuration, Loading...      |

</details>

<details>
<summary>📁 New-safe (19 families, 22 components) - ❌ 0/19 covered, 0 exports</summary>

| Family                   | Path                                                       | Components | Story | Exports |
| ------------------------ | ---------------------------------------------------------- | ---------- | ----- | ------- |
| AdvancedOptionsStep      | components/new-safe/create/steps/AdvancedOptionsStep       | 1          | —     | —       |
| CardStepper              | components/new-safe/CardStepper                            | 1          | —     | —       |
| Create                   | components/new-safe/create                                 | 2          | —     | —       |
| CreateSafeInfos          | components/new-safe/create/CreateSafeInfos                 | 1          | —     | —       |
| InfoWidget               | components/new-safe/create/InfoWidget                      | 1          | —     | —       |
| Load                     | components/new-safe/load                                   | 1          | —     | —       |
| LoadingSpinner           | components/new-safe/create/steps/StatusStep/LoadingSpinner | 1          | —     | —       |
| NetworkWarning           | components/new-safe/create/NetworkWarning                  | 1          | —     | —       |
| NoWalletConnectedWarning | components/new-safe/create/NoWalletConnectedWarning        | 1          | —     | —       |
| OverviewWidget           | components/new-safe/create/OverviewWidget                  | 1          | —     | —       |
| OwnerPolicyStep          | components/new-safe/create/steps/OwnerPolicyStep           | 1          | —     | —       |
| OwnerRow                 | components/new-safe/OwnerRow                               | 1          | —     | —       |
| ReviewRow                | components/new-safe/ReviewRow                              | 1          | —     | —       |
| ReviewStep               | components/new-safe/create/steps/ReviewStep                | 1          | —     | —       |
| SafeOwnerStep            | components/new-safe/load/steps/SafeOwnerStep               | 1          | —     | —       |
| SafeReviewStep           | components/new-safe/load/steps/SafeReviewStep              | 1          | —     | —       |
| SetAddressStep           | components/new-safe/load/steps/SetAddressStep              | 1          | —     | —       |
| SetNameStep              | components/new-safe/create/steps/SetNameStep               | 1          | —     | —       |
| StatusStep               | components/new-safe/create/steps/StatusStep                | 3          | —     | —       |

</details>

<details>
<summary>📁 Nfts (5 families, 5 components) - ✅ 5/5 covered (2 with own stories), 8 exports</summary>

| Family          | Path                                     | Components | Story                         | Exports                         |
| --------------- | ---------------------------------------- | ---------- | ----------------------------- | ------------------------------- |
| NftCollections  | features/nfts/components/NftCollections  | 1          | ↑ group (Nfts)                | —                               |
| NftGrid         | features/nfts/components/NftGrid         | 1          | `NftGrid.stories.tsx`         | Default, Loading, WithSelection |
| NftPreviewModal | features/nfts/components/NftPreviewModal | 1          | `NftPreviewModal.stories.tsx` | Default                         |
...
<details>
<summary>📁 No-fee-campaign (3 families, 3 components) - ✅ 3/3 covered (3 with own stories), 6 exports</summary>

| Family                       | Path                                                             | Components | Story               | Exports  |
| ---------------------------- | ---------------------------------------------------------------- | ---------- | ------------------- | -------- |
| GasTooHighBanner             | features/no-fee-campaign/components/GasTooHighBanner             | 1          | `index.stories.tsx` | Default  |
| NoFeeCampaignBanner          | features/no-fee-campaign/components/NoFeeCampaignBanner          | 1          | `index.stories.tsx` | Default  |
| NoFeeCampaignTransactionCard | features/no-fee-campaign/components/NoFeeCampaignTransactionCard | 1          | `index.stories.tsx` | Eligible |

</details>

<details>
<summary>📁 Notification-center (4 families, 4 components) - ✅ 4/4 covered (2 with own stories), 8 exports</summary>

| Family                 | Path                                                  | Components | Story                         | Exports        |
| ---------------------- | ----------------------------------------------------- | ---------- | ----------------------------- | -------------- |
| NotificationCenter     | components/notification-center/NotificationCenter     | 1          | `index.stories.tsx`           | Default, Open  |
| NotificationCenterItem | components/notification-center/NotificationCenterItem | 1          | ↑ group (Notification-center) | —              |
| NotificationCenterList | components/notification-center/NotificationCenterList | 1          | `index.stories.tsx`           | Default, Empty |
| NotificationRenewal    | components/notification-center/NotificationRenewal    | 1          | ↑ group (Notification-center) | —              |

</details>

<details>
<summary>📁 Oidc-auth (7 families, 8 components) - ✅ 7/7 covered (4 with own stories), 18 exports</summary>
...
| MemberTwoFactorBadge       | features/oidc-auth/components/MemberTwoFactorBadge       | 1          | `index.stories.tsx` | Active, InvitePending, WalletSignIn    |
| OidcSignInButton           | features/oidc-auth/components/OidcSignInButton           | 1          | ↑ group (Oidc-auth) | —                                      |
| SwitchAuthenticatorSection | features/oidc-auth/components/SwitchAuthenticatorSection | 2          | ↑ group (Oidc-auth) | —                                      |
| WalletTwoFactorSection     | features/oidc-auth/components/WalletTwoFactorSection     | 1          | ↑ group (Oidc-auth) | —                                      |
| WorkspaceTwoFactorSection  | features/oidc-auth/components/WorkspaceTwoFactorSection  | 1          | `index.stories.tsx` | AsNonAdmin, FullCoverage, NoMembers... |

</details>

<details>
<summary>📁 Pages (30 families, 65 components) - ❌ 0/30 covered, 0 exports</summary>
...
<details>
<summary>📁 Positions (8 families, 8 components) - ✅ 8/8 covered (4 with own stories), 10 exports</summary>
...
| PositionsEmpty         | features/positions/components/PositionsEmpty         | 1          | `index.stories.tsx`             | Default            |
...
<details>
<summary>📁 Proposers (1 families, 7 components) - ❌ 0/1 covered, 0 exports</summary>

| Family     | Path                          | Components | Story | Exports |
| ---------- | ----------------------------- | ---------- | ----- | ------- |
| Components | features/proposers/components | 7          | —     | —       |

</details>

<details>
<summary>📁 Recovery (21 families, 26 components) - ✅ 21/21 covered (1 with own stories), 8 exports</summary>
...
| RecoveryCards            | features/recovery/components/RecoveryCards            | 2          | `RecoveryInProgressCard.stories.tsx` | Executable, Expired, Horizontal... |
...
<details>
<summary>📁 Safe-apps (21 families, 34 components) - ✅ 21/21 covered (3 with own stories), 22 exports</summary>
...
| TransactionQueueBar            | components/safe-apps/AppFrame/TransactionQueueBar   | 1          | `TransactionQueueBar.stories.tsx` | Collapsed, Expanded, LongQueue       |

</details>

<details>
<summary>📁 Safe-messages (14 families, 15 components) - ❌ 0/14 covered, 0 exports</summary>

| Family        | Path                                   | Components | Story | Exports |
| ------------- | -------------------------------------- | ---------- | ----- | ------- |
| DecodedMsg    | components/safe-messages/DecodedMsg    | 1          | —     | —       |
| InfoBox       | components/safe-messages/InfoBox       | 1          | —     | —       |
| Msg           | components/safe-messages/Msg           | 1          | —     | —       |
| MsgAuditLog   | components/safe-messages/MsgAuditLog   | 1          | —     | —       |
| MsgDetails    | components/safe-messages/MsgDetails    | 1          | —     | —       |
| MsgList       | components/safe-messages/MsgList       | 1          | —     | —       |
| MsgListItem   | components/safe-messages/MsgListItem   | 2          | —     | —       |
| MsgShareLink  | components/safe-messages/MsgShareLink  | 1          | —     | —       |
| MsgSigners    | components/safe-messages/MsgSigners    | 1          | —     | —       |
| MsgSummary    | components/safe-messages/MsgSummary    | 1          | —     | —       |
| MsgType       | components/safe-messages/MsgType       | 1          | —     | —       |
| PaginatedMsgs | components/safe-messages/PaginatedMsgs | 1          | —     | —       |
| SignMsgButton | components/safe-messages/SignMsgButton | 1          | —     | —       |
| SingleMsg     | components/safe-messages/SingleMsg     | 1          | —     | —       |

</details>

<details>
<summary>📁 Safe-overview (2 families, 2 components) - ✅ 2/2 covered (2 with own stories), 6 exports</summary>

| Family        | Path                                            | Components | Story               | Exports          |
| ------------- | ----------------------------------------------- | ---------- | ------------------- | ---------------- |
| AccountHeader | features/safe-overview/components/AccountHeader | 1          | `index.stories.tsx` | Empty, Populated |
| Safe-overview | features/safe-overview                          | 1          | `index.stories.tsx` | Empty, Populated |

</details>

<details>
<summary>📁 Safe-shield (13 families, 25 components) - ❌ 0/13 covered, 0 exports</summary>

| Family                  | Path                                                    | Components | Story | Exports |
| ----------------------- | ------------------------------------------------------- | ---------- | ----- | ------- |
| AddressChanges          | features/safe-shield/components/AddressChanges          | 1          | —     | —       |
| AddressImage            | features/safe-shield/components/AddressImage            | 1          | —     | —       |
| AnalysisDetailsDropdown | features/safe-shield/components/AnalysisDetailsDropdown | 1          | —     | —       |
| AnalysisGroupCard       | features/safe-shield/components/AnalysisGroupCard       | 6          | —     | —       |
| AnalysisIssuesDisplay   | features/safe-shield/components/AnalysisIssuesDisplay   | 1          | —     | —       |
| Components              | features/safe-shield/components                         | 4          | —     | —       |
| HighlightedAddress      | features/safe-shield/components/HighlightedAddress      | 1          | —     | —       |
| ReportFalseResultModal  | features/safe-shield/components/ReportFalseResultModal  | 1          | —     | —       |
| Safe-shield             | features/safe-shield                                    | 2          | —     | —       |
| SafeShieldContent       | features/safe-shield/components/SafeShieldContent       | 3          | —     | —       |
| ShowAllAddress          | features/safe-shield/components/ShowAllAddress          | 1          | —     | —       |
| ThreatAnalysis          | features/safe-shield/components/ThreatAnalysis          | 2          | —     | —       |
| UntrustedSafeWarning    | features/safe-shield/components/UntrustedSafeWarning    | 1          | —     | —       |

</details>

<details>
<summary>📁 Settings (21 families, 27 components) - ✅ 21/21 covered (4 with own stories), 28 exports</summary>
...
| ProposersList         | components/settings/ProposersList                      | 1          | `index.stories.tsx`                 | Default, Empty                           |
...
| SettingsCard          | components/settings/SettingsCard                       | 1          | ↑ group (Settings)                  | —                                        |
...
<details>
<summary>📁 Spaces (77 families, 180 components) - ✅ 77/77 covered (26 with own stories), 162 exports</summary>
...
| AddAccounts                | features/spaces/components/AddAccounts                                      | 2          | ↑ group (Spaces)                      | —                                                                 |
...
| Components                 | features/spaces/components/SafeSelectorDropdown/components                  | 13         | ↑ group (Spaces)                      | —                                                                 |
| Components                 | features/spaces/components/SelectSafesOnboarding/components                 | 1          | ↑ group (Spaces)                      | —                                                                 |
...
| HeaderNavigation           | features/spaces/components/HeaderNavigation                                 | 2          | `HeaderNavigation.stories.tsx`        | AllVariations, Default, Disconnected...                           |
...
| SafeAccounts               | features/spaces/components/SafeAccounts                                     | 7          | ↑ group (Spaces)                      | —                                                                 |
...
| SafeWidget                 | features/spaces/components/SafeWidget                                       | 8          | `SafeWidget.stories.tsx`              | Assets, EmptyState, ErrorState...                                 |
...
| SidebarDeveloperGroup      | features/spaces/components/Sidebar/variants/SidebarDeveloperGroup           | 2          | ↑ group (Spaces)                      | —                                                                 |
...
| SpaceAddressBook           | features/spaces/components/SpaceAddressBook                                 | 14         | ↑ group (Spaces)                      | —                                                                 |
...
| SpaceSettings              | features/spaces/components/SpaceSettings                                    | 9          | ↑ group (Spaces)                      | —                                                                 |
...
<details>
<summary>📁 Speedup (2 families, 2 components) - ✅ 2/2 covered (2 with own stories), 6 exports</summary>

| Family         | Path                                       | Components | Story               | Exports               |
| -------------- | ------------------------------------------ | ---------- | ------------------- | --------------------- |
| SpeedUpModal   | features/speedup/components/SpeedUpModal   | 1          | `index.stories.tsx` | Default               |
| SpeedUpMonitor | features/speedup/components/SpeedUpMonitor | 1          | `index.stories.tsx` | AlertBox, AlertButton |

</details>

<details>
<summary>📁 Spending-limits (7 families, 10 components) - ✅ 7/7 covered (6 with own stories), 24 exports</summary>

| Family                    | Path                                                          | Components | Story                     | Exports                                      |
| ------------------------- | ------------------------------------------------------------- | ---------- | ------------------------- | -------------------------------------------- |
| CreateSpendingLimit       | features/spending-limits/components/CreateSpendingLimit       | 2          | `index.stories.tsx`       | Empty, Prefilled                             |
| RemoveSpendingLimitReview | features/spending-limits/components/RemoveSpendingLimitReview | 1          | `index.stories.tsx`       | Default                                      |
| ReviewSpendingLimit       | features/spending-limits/components/ReviewSpendingLimit       | 1          | `index.stories.tsx`       | Default                                      |
| ReviewSpendingLimitTx     | features/spending-limits/components/ReviewSpendingLimitTx     | 1          | `index.stories.tsx`       | Default, NativeToken                         |
| SpendingLimitRow          | features/spending-limits/components/SpendingLimitRow          | 1          | `index.stories.tsx`       | BothOptions, SpendingLimitOnly, StandardOnly |
| SpendingLimitsLoader      | features/spending-limits/components/SpendingLimitsLoader      | 1          | ↑ group (Spending-limits) | —                                            |
| SpendingLimitsSettings    | features/spending-limits/components/SpendingLimitsSettings    | 3          | `index.stories.tsx`       | Empty, Loading, WithLimits                   |

</details>

<details>
<summary>📁 Stake (5 families, 6 components) - ✅ 5/5 covered (5 with own stories), 20 exports</summary>

| Family                | Path                                            | Components | Story               | Exports                             |
| --------------------- | ----------------------------------------------- | ---------- | ------------------- | ----------------------------------- |
| StakeButton           | features/stake/components/StakeButton           | 1          | `index.stories.tsx` | Disabled, Enabled, IconOnly...      |
| StakePage             | features/stake/components/StakePage             | 1          | `index.stories.tsx` | ConsentDisclaimer                   |
| StakingConfirmationTx | features/stake/components/StakingConfirmationTx | 2          | `Exit.stories.tsx`  | MultipleValidators, SingleValidator |
| StakingPromoBanner    | features/stake/components/StakingPromoBanner    | 1          | `index.stories.tsx` | Default                             |
| StakingWidget         | features/stake/components/StakingWidget         | 1          | `index.stories.tsx` | Default, WithAsset                  |
...
<details>
<summary>📁 Support-chat (1 families, 1 components) - ✅ 1/1 covered (1 with own stories), 4 exports</summary>

| Family     | Path                             | Components | Story                           | Exports             |
| ---------- | -------------------------------- | ---------- | ------------------------------- | ------------------- |
| Components | features/support-chat/components | 1          | `SupportChatDrawer.stories.tsx` | ErrorState, Loading |
...
<details>
<summary>📁 Targeted-outreach (1 families, 1 components) - ✅ 1/1 covered (1 with own stories), 2 exports</summary>

| Family        | Path                                                | Components | Story               | Exports |
| ------------- | --------------------------------------------------- | ---------- | ------------------- | ------- |
| OutreachPopup | features/targeted-outreach/components/OutreachPopup | 1          | `index.stories.tsx` | Default |

</details>

<details>
<summary>📁 Transactions (53 families, 69 components) - ✅ 53/53 covered (7 with own stories), 70 exports</summary>
...
| TxSummary                   | components/transactions/TxSummary                                              | 2          | `TxSummary.stories.tsx`           | AllTypesStacked, AllTypesStackedAt1000, AllTypesStackedAt360... |
...
<details>
<summary>📁 Transactions (1 families, 1 components) - ✅ 1/1 covered (1 with own stories), 6 exports</summary>

| Family        | Path                                           | Components | Story               | Exports                   |
| ------------- | ---------------------------------------------- | ---------- | ------------------- | ------------------------- |
| PendingTxList | features/transactions/components/PendingTxList | 1          | `index.stories.tsx` | Empty, Loading, Populated |

</details>

<details>
<summary>📁 Tx (35 families, 54 components) - ✅ 35/35 covered (12 with own stories), 54 exports</summary>

| Family                  | Path                                                    | Components | Story                                | Exports                                |
| ----------------------- | ------------------------------------------------------- | ---------- | ------------------------------------ | -------------------------------------- |
| AdvancedParams          | components/tx/AdvancedParams                            | 3          | ↑ group (Tx)                         | —                                      |
| ApprovalEditor          | components/tx/ApprovalEditor                            | 7          | `ApprovalValueField.stories.tsx`     | Editable, ReadOnly, UnlimitedAmount    |
...
| TxCheckError            | components/tx/TxCheckError                              | 1          | ↑ group (Tx)                         | —                                      |
| TxSubmitError           | components/tx/TxSubmitError                             | 1          | ↑ group (Tx)                         | —                                      |
| UpdateSafe              | components/tx/confirmation-views/UpdateSafe             | 1          | `UpdateSafe.stories.tsx`             | Default, L2Upgrade, UnknownContract... |

</details>

<details>
<summary>📁 Tx-flow (60 families, 115 components) - ✅ 60/60 covered (3 with own stories), 16 exports</summary>
...
| NewTx                  | components/tx-flow/flows/NewTx                                       | 1          | `index.stories.tsx`           | Default, SendTokensJourney             |
...
| Tx-flow                | components/tx-flow                                                   | 7          | ↑ group (Tx-flow)             | —                                      |
...
| TxLayoutBase           | components/tx-flow/common/TxLayoutBase                               | 1          | ↑ group (Tx-flow)             | —                                      |
| TxNonce                | components/tx-flow/common/TxNonce                                    | 1          | `TxNonce.stories.tsx`         | Editable, ReadOnly                     |
...
<details>
<summary>📁 Tx-notes (3 families, 3 components) - ✅ 3/3 covered (2 with own stories), 6 exports</summary>

| Family      | Path                                     | Components | Story               | Exports           |
| ----------- | ---------------------------------------- | ---------- | ------------------- | ----------------- |
| TxNote      | features/tx-notes/components/TxNote      | 1          | `index.stories.tsx` | Default, LongNote |
| TxNoteForm  | features/tx-notes/components/TxNoteForm  | 1          | ↑ group (Tx-notes)  | —                 |
| TxNoteInput | features/tx-notes/components/TxNoteInput | 1          | `index.stories.tsx` | Default           |

</details>

<details>
<summary>📁 Ui (52 families, 52 components) - ✅ 52/52 covered (51 with own stories), 168 exports</summary>

| Family          | Path                          | Components | Story                         | Exports                                       |
| --------------- | ----------------------------- | ---------- | ----------------------------- | --------------------------------------------- |
| Accordion       | components/ui/accordion       | 1          | `accordion.stories.tsx`       | AllVariants                                   |
| Alert           | components/ui/alert           | 1          | `alert.stories.tsx`           | AllVariants, Playground                       |
| Alert-dialog    | components/ui/alert-dialog    | 1          | `alert-dialog.stories.tsx`    | AllVariants, Open                             |
...
| Button          | components/ui/button          | 1          | `button.stories.tsx`          | AllVariants, Guidelines                       |
...
| Context-menu    | components/ui/context-menu    | 1          | `context-menu.stories.tsx`    | AllVariants, Open                             |
| Dialog          | components/ui/dialog          | 1          | `dialog.stories.tsx`          | AllVariants, DividedHeaderFooter, Open...     |
| Drawer          | components/ui/drawer          | 1          | `drawer.stories.tsx`          | AllVariants, Open                             |
| Dropdown-menu   | components/ui/dropdown-menu   | 1          | `dropdown-menu.stories.tsx`   | AllVariants, Open                             |
| Empty           | components/ui/empty           | 1          | `empty.stories.tsx`           | AllVariants                                   |
| Field           | components/ui/field           | 1          | `field.stories.tsx`           | AllVariants                                   |
| Hover-card      | components/ui/hover-card      | 1          | `hover-card.stories.tsx`      | AllVariants, Open                             |
...
| Popover         | components/ui/popover         | 1          | `popover.stories.tsx`         | AllVariants, Open                             |
...
| Search-input    | components/ui/search-input    | 1          | `search-input.stories.tsx`    | AllVariants, Default                          |
...
| Sheet           | components/ui/sheet           | 1          | `sheet.stories.tsx`           | AllVariants, DividedHeaderFooter, Floating... |
...
| Sonner          | components/ui/sonner          | 1          | `sonner.stories.tsx`          | AllVariants, Open                             |
...
| Tooltip         | components/ui/tooltip         | 1          | `tooltip.stories.tsx`         | AllVariants, Open                             |
| Typography      | components/ui/typography      | 1          | `typography.stories.tsx`      | Alignment, Colors, Default...                 |

</details>

<details>
<summary>📁 Wallet (1 families, 1 components) - ✅ 1/1 covered (1 with own stories), 4 exports</summary>

| Family        | Path                                     | Components | Story               | Exports                |
| ------------- | ---------------------------------------- | ---------- | ------------------- | ---------------------- |
| WalletPopover | features/wallet/components/WalletPopover | 1          | `index.stories.tsx` | Default, WalletConnect |

</details>

<details>
<summary>📁 Walletconnect (13 families, 17 components) - ✅ 13/13 covered (2 with own stories), 12 exports</summary>
...
| WcProposalForm       | features/walletconnect/components/WcProposalForm       | 3          | `WcProposalForm.stories.tsx` | Blocked, Default, HighRisk... |
| WcSessionList        | features/walletconnect/components/WcSessionList        | 2          | `WcSessionList.stories.tsx`  | ActiveSessions, NoSessions    |
| WcSessionManager     | features/walletconnect/components/WcSessionManager     | 1          | ↑ group (Walletconnect)      | —                             |

</details>

<details>
<summary>📁 Welcome (1 families, 1 components) - ❌ 0/1 covered, 0 exports</summary>

| Family       | Path                            | Components | Story | Exports |
| ------------ | ------------------------------- | ---------- | ----- | ------- |
| WelcomeLogin | components/welcome/WelcomeLogin | 1          | —     | —       |
...
## 3. Component Coverage (1122 components)
...
<details>
<summary>✅ Components Covered (973) - click to expand</summary>
...
| AccountHeader                    | other       | features/safe-overview/components/AccountHeader/index.tsx                                             | Own story (AccountHeader)                |
...
| AccountsSection                  | other       | features/global-search/components/SearchSection/sections/Accounts/AccountsSection.tsx                 | Own story (AccountsSection)              |
| AccountsWidget                   | other       | features/myAccounts/components/AccountsWidget/AccountsWidget.tsx                                      | Own story (AccountsWidget)               |
| ActionBar                        | common      | components/common/ActionBar/index.tsx                                                                 | Family (ActionBar)                       |
...
| AddAccountsChooser               | common      | components/common/AddAccountsChooser/index.tsx                                                        | Family (AddAccountsChooser)              |
...
| AddressBookInput                 | common      | components/common/AddressBookInput/index.tsx                                                          | Family (AddressBookInput)                |
...
| AddTrustedSafesCard              | common      | components/common/AddTrustedSafesCard/index.tsx                                                       | Family (AddTrustedSafesCard)             |
...
| ApprovalEditor                   | transaction | components/tx/ApprovalEditor/index.tsx                                                                | Family (ApprovalEditor)                  |
| ApprovalEditorForm               | transaction | components/tx/ApprovalEditor/ApprovalEditorForm.tsx                                                   | Family (ApprovalEditor)                  |
| ApprovalItem                     | transaction | components/tx/ApprovalEditor/ApprovalItem.tsx                                                         | Family (ApprovalEditor)                  |
| Approvals                        | transaction | components/tx/ApprovalEditor/Approvals.tsx                                                            | Family (ApprovalEditor)                  |
| ApprovalValueField               | transaction | components/tx/ApprovalEditor/ApprovalValueField.tsx                                                   | Own story (ApprovalValueField)           |
...
| AssetsList                       | balance     | features/assets/components/AssetsList/index.tsx                                                       | Own story (AssetsList)                   |
...
| Autocomplete                     | ui          | components/ui/combobox.tsx                                                                            | Own story (combobox)                     |
...
| BatchSidebar                     | other       | features/batching/components/BatchSidebar/index.tsx                                                   | Own story (BatchSidebar)                 |
| BatchTooltip                     | other       | features/batching/components/BatchTooltip/index.tsx                                                   | Own story (BatchTooltip)                 |
| BatchTransactions                | transaction | components/tx/confirmation-views/BatchTransactions/index.tsx                                          | Family (BatchTransactions)               |
| BatchTxItem                      | other       | features/batching/components/BatchSidebar/BatchTxItem.tsx                                             | Own story (BatchTxItem)                  |
| BatchTxList                      | other       | features/batching/components/BatchSidebar/BatchTxList.tsx                                             | Own story (BatchTxList)                  |
...
| BridgeWidget                     | other       | features/bridge/components/BridgeWidget/index.tsx                                                     | Own story (BridgeWidget)                 |
...
| CheckBalance                     | other       | features/counterfactual/components/CheckBalance/index.tsx                                             | Family (CheckBalance)                    |
...
| ChooserRow                       | common      | components/common/ChooserRow/index.tsx                                                                | Group (Common)                           |
...
| CompatibilityWarning             | other       | features/walletconnect/components/WcProposalForm/CompatibilityWarning.tsx                             | Family (WcProposalForm)                  |
...
| CopyAddressButton                | common      | components/common/AccountRow/CopyAddressButton.tsx                                                    | Group (Common)                           |
...
| CreateSpendingLimit              | other       | features/spending-limits/components/CreateSpendingLimit/index.tsx                                     | Own story (CreateSpendingLimit)          |
...
| DialogActions                    | common      | components/common/DialogActions/index.tsx                                                             | Family (DialogActions)                   |
...
| DragHandle                       | other       | features/spaces/components/SafeSelectorDropdown/components/DragHandle.tsx                             | Group (Spaces)                           |
...
| EditableApprovalItem             | transaction | components/tx/ApprovalEditor/EditableApprovalItem.tsx                                                 | Family (ApprovalEditor)                  |
...
| EmptyBatch                       | other       | features/batching/components/BatchSidebar/EmptyBatch.tsx                                              | Own story (EmptyBatch)                   |
...
| ErrorDetails                     | common      | components/common/ErrorDetails/index.tsx                                                              | Group (Common)                           |
...
| ExplorerLinkButton               | common      | components/common/AccountRow/ExplorerLinkButton.tsx                                                   | Group (Common)                           |
...
| FiatBalance                      | common      | components/common/FiatBalance/index.tsx                                                               | Group (Common)                           |
...
| FullAddress                      | common      | components/common/AccountRow/FullAddress.tsx                                                          | Group (Common)                           |
...
| GasTooHighBanner                 | other       | features/no-fee-campaign/components/GasTooHighBanner/index.tsx                                        | Own story (GasTooHighBanner)             |
...
| GetStartedCard                   | other       | features/myAccounts/components/MyAccountsV2/components/GetStartedCard/index.tsx                       | Family (GetStartedCard)                  |
| GlobalPushNotifications          | settings    | components/settings/PushNotifications/GlobalPushNotifications.tsx                                     | Group (Settings)                         |
| GlobalSearch                     | other       | features/global-search/components/GlobalSearchModal/GlobalSearch.tsx                                  | Own story (GlobalSearch)                 |
| GlobalSearchInput                | other       | features/global-search/components/GlobalSearchInput/index.tsx                                         | Own story (GlobalSearchInput)            |
| GlobalSearchModal                | other       | features/global-search/components/GlobalSearchModal/GlobalSearchModal.tsx                             | Own story (GlobalSearchModal)            |
| GlobalSearchModal                | other       | features/global-search/components/GlobalSearchModal/index.tsx                                         | Family (GlobalSearchModal)               |
...
| HeaderAccountInfo                | other       | features/spaces/components/HeaderNavigation/HeaderAccountInfo.tsx                                     | Family (HeaderNavigation)                |
...
| IconAction                       | common      | components/common/IconAction/index.tsx                                                                | Family (IconAction)                      |
...
| InternalRecoveryProposalCard     | other       | features/recovery/components/RecoveryCards/RecoveryProposalCard.tsx                                   | Own story (RecoveryProposalCard)         |
| IntroText                        | common      | components/common/CookieAndTermBanner/IntroText.tsx                                                   | Group (Common)                           |
| InvalidContactNameTooltip        | other       | features/spaces/components/SpaceAddressBook/InvalidContactNameTooltip.tsx                             | Group (Spaces)                           |
...
| ManageTrustedSafesContent        | common      | components/common/TrustedSafesModal/ManageTrustedSafesContent.tsx                                     | Family (TrustedSafesModal)               |
| MarkdownContent                  | common      | components/common/MarkdownContent/index.tsx                                                           | Group (Common)                           |
| MastercopyWarning                | other       | features/multichain/components/MastercopyWarning/MastercopyWarning.tsx                                | Own story (MastercopyWarning)            |
...
| MemberTwoFactorBadge             | other       | features/oidc-auth/components/MemberTwoFactorBadge/index.tsx                                          | Own story (MemberTwoFactorBadge)         |
...
| NavigateToSection                | other       | features/global-search/components/SearchSection/sections/NavigateTo/NavigateToSection.tsx             | Own story (NavigateToSection)            |
...
| NestedSafeInfo                   | other       | components/nested-safes/NestedSafeInfo/index.tsx                                                      | Own story (NestedSafeInfo)               |
| NestedSafeIntro                  | other       | components/nested-safes/NestedSafeIntro/index.tsx                                                     | Own story (NestedSafeIntro)              |
| NestedSafesList                  | other       | components/nested-safes/NestedSafesList/index.tsx                                                     | Own story (NestedSafesList)              |
| NestedSafesList                  | settings    | components/settings/NestedSafesList/index.tsx                                                         | Group (Settings)                         |
| NestedSafesPopover               | other       | components/nested-safes/NestedSafesPopover/index.tsx                                                  | Own story (NestedSafesPopover)           |
...
| NetworkLogosPill                 | other       | features/multichain/components/NetworkLogosPill/index.tsx                                             | Family (NetworkLogosPill)                |
| NetworkLogosTooltip              | other       | features/multichain/components/NetworkLogosTooltip/index.tsx                                          | Group (Multichain)                       |
...
| NewTxFlow                        | other       | components/tx-flow/flows/NewTx/index.tsx                                                              | Own story (NewTx)                        |
| NftCollections                   | other       | features/nfts/components/NftCollections/index.tsx                                                     | Group (Nfts)                             |
| NftGrid                          | other       | features/nfts/components/NftGrid/index.tsx                                                            | Family (NftGrid)                         |
| NftItems                         | other       | components/tx-flow/flows/NftTransfer/SendNftBatch.tsx                                                 | Group (Tx-flow)                          |
| NftPreviewModal                  | other       | features/nfts/components/NftPreviewModal/index.tsx                                                    | Family (NftPreviewModal)                 |
...
| NoFeeCampaignTransactionCard     | other       | features/no-fee-campaign/components/NoFeeCampaignTransactionCard/index.tsx                            | Own story (NoFeeCampaignTransactionCard) |
...
| NoSpendingLimits                 | other       | features/spending-limits/components/SpendingLimitsSettings/NoSpendingLimits.tsx                       | Own story (NoSpendingLimits)             |
| NotActivatedBadge                | common      | components/common/NotActivatedBadge/index.tsx                                                         | Group (Common)                           |
| NotificationCenter               | other       | components/notification-center/NotificationCenter/index.tsx                                           | Own story (NotificationCenter)           |
| NotificationCenterItem           | other       | components/notification-center/NotificationCenterItem/index.tsx                                       | Group (Notification-center)              |
| NotificationCenterList           | other       | components/notification-center/NotificationCenterList/index.tsx                                       | Own story (NotificationCenterList)       |
| NotificationLink                 | common      | components/common/Notifications/index.tsx                                                             | Family (Notifications)                   |
...
| OnboardingFooter                 | common      | components/common/OnboardingFooter/index.tsx                                                          | Family (OnboardingFooter)                |
...
| OutreachPopup                    | other       | features/targeted-outreach/components/OutreachPopup/index.tsx                                         | Own story (OutreachPopup)                |
...
| PayNowPayLater                   | other       | features/counterfactual/components/PayNowPayLater/index.tsx                                           | Family (PayNowPayLater)                  |
...
| PositionsEmpty                   | other       | features/positions/components/PositionsEmpty/index.tsx                                                | Own story (PositionsEmpty)               |
...
| ProposalVerification             | other       | features/walletconnect/components/WcProposalForm/ProposalVerification.tsx                             | Family (WcProposalForm)                  |
| ProposerForm                     | other       | components/tx-flow/actions/Propose/ProposerForm.tsx                                                   | Group (Tx-flow)                          |
| ProposersList                    | settings    | components/settings/ProposersList/index.tsx                                                           | Own story (ProposersList)                |
...
| QueueActions                     | transaction | components/transactions/TxSummary/QueueActions.tsx                                                    | Family (TxSummary)                       |
...
| RecipientGroupHeader             | common      | components/common/AddressBookInput/RecipientGroupHeader.tsx                                           | Family (AddressBookInput)                |
| RecipientOption                  | common      | components/common/AddressBookInput/RecipientOption.tsx                                                | Family (AddressBookInput)                |
...
| RecoveryInProgressCard           | other       | features/recovery/components/RecoveryCards/RecoveryInProgressCard.tsx                                 | Own story (RecoveryInProgressCard)       |
...
| RemoveSpendingLimitReview        | other       | features/spending-limits/components/RemoveSpendingLimitReview/index.tsx                               | Own story (RemoveSpendingLimitReview)    |
| RenameButton                     | common      | components/common/AccountRow/RenameButton.tsx                                                         | Group (Common)                           |
| RenewInviteButton                | other       | features/spaces/components/MembersList/RenewInviteButton.tsx                                          | Own story (RenewInviteButton)            |
| ReorderableBody                  | other       | features/myAccounts/components/SafeAccountsTable/ReorderableBody.tsx                                  | Family (SafeAccountsTable)               |
| ReorderableSafeList              | other       | features/spaces/components/SafeSelectorDropdown/components/ReorderableSafeList.tsx                    | Group (Spaces)                           |
...
| ResetAuthenticatorDialog         | other       | features/oidc-auth/components/SwitchAuthenticatorSection/ResetAuthenticatorDialog.tsx                 | Group (Oidc-auth)                        |
...
| ReviewSpendingLimit              | other       | features/spending-limits/components/ReviewSpendingLimit/index.tsx                                     | Own story (ReviewSpendingLimit)          |
| ReviewSpendingLimitTx            | other       | features/spending-limits/components/ReviewSpendingLimitTx/index.tsx                                   | Own story (ReviewSpendingLimitTx)        |
...
| RowIconAction                    | common      | components/common/AccountRow/RowIconAction.tsx                                                        | Group (Common)                           |
| RpcProviderSection               | settings    | components/settings/EnvironmentVariables/RpcProviderSection.tsx                                       | Group (Settings)                         |
| SafeAccountsTable                | other       | features/myAccounts/components/SafeAccountsTable/index.tsx                                            | Family (SafeAccountsTable)               |
| SafeAccountTableRow              | other       | features/myAccounts/components/SafeAccountsTable/SafeAccountTableRow.tsx                              | Family (SafeAccountsTable)               |
...
| SafeInfoDisplay                  | common      | components/common/AccountRow/SafeInfoDisplay.tsx                                                      | Group (Common)                           |
...
| SafeOverview                     | other       | features/safe-overview/index.tsx                                                                      | Own story (safe-overview)                |
| SafeRowStats                     | other       | features/spaces/components/SafeSelectorDropdown/components/SafeRowStats.tsx                           | Group (Spaces)                           |
...
| SafeTxContext                    | other       | components/tx-flow/SafeTxProvider.tsx                                                                 | Group (Tx-flow)                          |
...
| SearchInput                      | ui          | components/ui/search-input.tsx                                                                        | Own story (search-input)                 |
| SearchSection                    | other       | features/global-search/components/SearchSection/SearchSection.tsx                                     | Own story (SearchSection)                |
| SectionPanel                     | other       | features/spaces/components/SecurityHub/components/SecurityChecks/SectionPanel.tsx                     | Group (Spaces)                           |
| SectionVisibilityProvider        | other       | features/global-search/components/SearchSection/SectionVisibilityContext.tsx                          | Family (SearchSection)                   |
| SectionWrapper                   | other       | features/global-search/components/SearchSection/SectionWrapper.tsx                                    | Family (SearchSection)                   |
...
| SettingsCard                     | settings    | components/settings/SettingsCard/index.tsx                                                            | Group (Settings)                         |
...
| SidebarDeveloperGroup            | sidebar     | features/spaces/components/Sidebar/variants/SidebarDeveloperGroup/SidebarDeveloperGroup.tsx           | Group (Spaces)                           |
| SidebarDeveloperItem             | sidebar     | features/spaces/components/Sidebar/variants/SidebarDeveloperGroup/SidebarDeveloperItem.tsx            | Group (Spaces)                           |
...
| SidebarListItemCounter           | common      | components/common/SidebarList/index.tsx                                                               | Group (Common)                           |
...
| SimilarityConfirmDialog          | other       | components/nested-safes/NestedSafesList/SimilarityConfirmDialog.tsx                                   | Own story (SimilarityConfirmDialog)      |
| SimilarityGroupContainer         | other       | components/nested-safes/NestedSafesList/SimilarityGroupContainer.tsx                                  | Own story (SimilarityGroupContainer)     |
| SimilarityWarning                | other       | components/nested-safes/NestedSafesList/SimilarityWarning.tsx                                         | Own story (SimilarityWarning)            |
| SimilarityWarningIcon            | other       | features/myAccounts/components/SafeAccountsTable/SimilarityBand.tsx                                   | Family (SafeAccountsTable)               |
...
| SpaceRow                         | other       | features/spaces/components/SpacesList/SpaceRow.tsx                                                    | Group (Spaces)                           |
...
| SpaceSettingsSectionTitle        | other       | features/spaces/components/SpaceSettings/SpaceSettingsSection.tsx                                     | Group (Spaces)                           |
...
| SpeedUpModal                     | other       | features/speedup/components/SpeedUpModal/index.tsx                                                    | Own story (SpeedUpModal)                 |
| SpeedUpMonitor                   | other       | features/speedup/components/SpeedUpMonitor/index.tsx                                                  | Own story (SpeedUpMonitor)               |
| SpenderField                     | transaction | components/tx/ApprovalEditor/SpenderField.tsx                                                         | Family (ApprovalEditor)                  |
| SpendingLimitLabel               | common      | components/common/SpendingLimitLabel/index.tsx                                                        | Family (SpendingLimitLabel)              |
| SpendingLimitNotSupported        | other       | features/spending-limits/components/CreateSpendingLimit/SpendingLimitNotSupported.tsx                 | Own story (SpendingLimitNotSupported)    |
| SpendingLimitRow                 | other       | features/spending-limits/components/SpendingLimitRow/index.tsx                                        | Own story (SpendingLimitRow)             |
...
| SpendingLimitsLoader             | other       | features/spending-limits/components/SpendingLimitsLoader/index.tsx                                    | Group (Spending-limits)                  |
| SpendingLimitsSettings           | other       | features/spending-limits/components/SpendingLimitsSettings/index.tsx                                  | Own story (SpendingLimitsSettings)       |
| SpendingLimitsTable              | other       | features/spending-limits/components/SpendingLimitsSettings/SpendingLimitsTable.tsx                    | Own story (SpendingLimitsTable)          |
...
| StakeButton                      | other       | features/stake/components/StakeButton/index.tsx                                                       | Own story (StakeButton)                  |
| StakePage                        | other       | features/stake/components/StakePage/index.tsx                                                         | Own story (StakePage)                    |
...
| StakingConfirmationTxExit        | other       | features/stake/components/StakingConfirmationTx/Exit.tsx                                              | Own story (Exit)                         |
...
| StakingPromoBanner               | other       | features/stake/components/StakingPromoBanner/index.tsx                                                | Own story (StakingPromoBanner)           |
...
| StakingWidget                    | other       | features/stake/components/StakingWidget/index.tsx                                                     | Own story (StakingWidget)                |
...
| StrakingConfirmationTx           | other       | features/stake/components/StakingConfirmationTx/index.tsx                                             | Own story (StakingConfirmationTx)        |
| SubmitButton                     | common      | components/common/SubmitButton/index.tsx                                                              | Family (SubmitButton)                    |
...
| SupportChatDrawer                | other       | features/support-chat/components/SupportChatDrawer.tsx                                                | Own story (SupportChatDrawer)            |
...
| SwitchAuthenticatorSection       | other       | features/oidc-auth/components/SwitchAuthenticatorSection/index.tsx                                    | Group (Oidc-auth)                        |
...
| ThresholdBadge                   | common      | components/common/AccountBadges/index.tsx                                                             | Family (AccountBadges)                   |
...
| TransactionQueueBar              | other       | components/safe-apps/AppFrame/TransactionQueueBar/index.tsx                                           | Family (TransactionQueueBar)             |
...
| TruncatedText                    | common      | components/common/AccountRow/TruncatedText.tsx                                                        | Group (Common)                           |
| TrustedAccountsActions           | other       | features/myAccounts/components/MyAccountsV2/components/TrustedAccountsActions/index.tsx               | Family (TrustedAccountsActions)          |
| TrustedSafesModal                | common      | components/common/TrustedSafesModal/index.tsx                                                         | Family (TrustedSafesModal)               |
| TrustedSafesSection              | other       | features/global-search/components/SearchSection/sections/TrustedSafes/TrustedSafesSection.tsx         | Own story (TrustedSafesSection)          |
...
| TxCheckError                     | transaction | components/tx/TxCheckError/index.tsx                                                                  | Group (Tx)                               |
...
| TxFlow                           | other       | components/tx-flow/TxFlow.tsx                                                                         | Group (Tx-flow)                          |
| TxFlowContent                    | common      | components/tx-flow/common/TxFlowContent/index.tsx                                                     | Group (Tx-flow)                          |
| TxFlowContext                    | other       | components/tx-flow/TxFlowProvider.tsx                                                                 | Group (Tx-flow)                          |
| TxFlowStep                       | other       | components/tx-flow/TxFlowStep.tsx                                                                     | Group (Tx-flow)                          |
| TxHeader                         | transaction | components/transactions/TxHeader/index.tsx                                                            | Group (Transactions)                     |
| TxIcon                           | transaction | features/transactions/components/PendingTxList/index.tsx                                              | Own story (PendingTxList)                |
| TxInfoContext                    | other       | components/tx-flow/TxInfoProvider.tsx                                                                 | Group (Tx-flow)                          |
| TxLayoutHeader                   | common      | components/tx-flow/common/TxLayout/index.tsx                                                          | Group (Tx-flow)                          |
| TxLayoutHeader                   | common      | components/tx-flow/common/TxLayoutBase/index.tsx                                                      | Group (Tx-flow)                          |
...
| TxModalContext                   | other       | components/tx-flow/index.tsx                                                                          | Group (Tx-flow)                          |
...
| TxNonce                          | common      | components/tx-flow/common/TxNonce/index.tsx                                                           | Family (TxNonce)                         |
| TxNote                           | other       | features/tx-notes/components/TxNote/index.tsx                                                         | Own story (TxNote)                       |
| TxNoteForm                       | other       | features/tx-notes/components/TxNoteForm/index.tsx                                                     | Group (Tx-notes)                         |
| TxNoteInput                      | other       | features/tx-notes/components/TxNoteInput/index.tsx                                                    | Own story (TxNoteInput)                  |
...
| TxSubmitError                    | transaction | components/tx/TxSubmitError/index.tsx                                                                 | Group (Tx)                               |
| TxSummary                        | transaction | components/transactions/TxSummary/index.tsx                                                           | Family (TxSummary)                       |
...
| useTxStepper                     | other       | components/tx-flow/useTxStepper.tsx                                                                   | Group (Tx-flow)                          |
...
| WalletPopover                    | other       | features/wallet/components/WalletPopover/index.tsx                                                    | Own story (WalletPopover)                |
| WalletRejectionError             | transaction | components/tx/shared/errors/WalletRejectionError.tsx                                                  | Group (Tx)                               |
| WalletTwoFactorSection           | other       | features/oidc-auth/components/WalletTwoFactorSection/index.tsx                                        | Group (Oidc-auth)                        |
...
| WcNoSessions                     | other       | features/walletconnect/components/WcSessionList/WcNoSessions.tsx                                      | Family (WcSessionList)                   |
| WcProposalForm                   | other       | features/walletconnect/components/WcProposalForm/index.tsx                                            | Family (WcProposalForm)                  |
| WcSessionList                    | other       | features/walletconnect/components/WcSessionList/index.tsx                                             | Family (WcSessionList)                   |
| WcSessionManager                 | other       | features/walletconnect/components/WcSessionManager/index.tsx                                          | Group (Walletconnect)                    |
| WelcomeContentCard               | common      | components/common/WelcomeContentCard/index.tsx                                                        | Group (Common)                           |
...
| WidgetViewAll                    | other       | features/spaces/components/SafeWidget/WidgetViewAll.tsx                                               | Family (SafeWidget)                      |
| WorkspaceAvatars                 | other       | features/myAccounts/components/SafeAccountsTable/cells.tsx                                            | Family (SafeAccountsTable)               |
...
| WorkspaceTwoFactorSection        | other       | features/oidc-auth/components/WorkspaceTwoFactorSection/index.tsx                                     | Own story (WorkspaceTwoFactorSection)    |

</details>

<details>
<summary>❌ Components Not Covered (149) - click to expand</summary>

| Component                     | Category    | Path                                                                                | Priority Score |
| ----------------------------- | ----------- | ----------------------------------------------------------------------------------- | -------------- |
| SeverityIcon                  | other       | features/safe-shield/components/SeverityIcon.tsx                                    | 15             |
| CardStepper                   | other       | components/new-safe/CardStepper/index.tsx                                           | 10             |
| AnalysisGroupCard             | other       | features/safe-shield/components/AnalysisGroupCard/AnalysisGroupCard.tsx             | 10             |
| Settings                      | settings    | pages/settings/index.tsx                                                            | 10             |
| EntryDialog                   | other       | components/address-book/EntryDialog/index.tsx                                       | 5              |
| ImportDialog                  | other       | components/address-book/ImportDialog/index.tsx                                      | 5              |
| RemoveDialog                  | other       | components/address-book/RemoveDialog/index.tsx                                      | 5              |
| OwnerRow                      | other       | components/new-safe/OwnerRow/index.tsx                                              | 5              |
| ReviewRow                     | other       | components/new-safe/ReviewRow/index.tsx                                             | 5              |
| AdvancedCreateSafe            | other       | components/new-safe/create/AdvancedCreateSafe.tsx                                   | 5              |
| CreateSafeInfos               | other       | components/new-safe/create/CreateSafeInfos/index.tsx                                | 5              |
| InfoWidget                    | other       | components/new-safe/create/InfoWidget/index.tsx                                     | 5              |
| NetworkWarning                | other       | components/new-safe/create/NetworkWarning/index.tsx                                 | 5              |
| NoWalletConnectedWarning      | other       | components/new-safe/create/NoWalletConnectedWarning/index.tsx                       | 5              |
| OverviewWidget                | other       | components/new-safe/create/OverviewWidget/index.tsx                                 | 5              |
| CreateSafe                    | other       | components/new-safe/create/index.tsx                                                | 5              |
| AdvancedOptionsStep           | other       | components/new-safe/create/steps/AdvancedOptionsStep/index.tsx                      | 5              |
| OwnerPolicyStep               | other       | components/new-safe/create/steps/OwnerPolicyStep/index.tsx                          | 5              |
| SetNameStep                   | other       | components/new-safe/create/steps/SetNameStep/index.tsx                              | 5              |
| LoadingSpinner                | other       | components/new-safe/create/steps/StatusStep/LoadingSpinner/index.tsx                | 5              |
| StatusMessage                 | other       | components/new-safe/create/steps/StatusStep/StatusMessage.tsx                       | 5              |
| StatusStep                    | other       | components/new-safe/create/steps/StatusStep/StatusStep.tsx                          | 5              |
| CreateSafeStatus              | other       | components/new-safe/create/steps/StatusStep/index.tsx                               | 5              |
| LoadSafeSteps                 | other       | components/new-safe/load/index.tsx                                                  | 5              |
| SafeOwnerStep                 | other       | components/new-safe/load/steps/SafeOwnerStep/index.tsx                              | 5              |
| SafeReviewStep                | other       | components/new-safe/load/steps/SafeReviewStep/index.tsx                             | 5              |
| InfoBox                       | other       | components/safe-messages/InfoBox/index.tsx                                          | 5              |
| Msg                           | other       | components/safe-messages/Msg/index.tsx                                              | 5              |
| MsgAuditLog                   | other       | components/safe-messages/MsgAuditLog/index.tsx                                      | 5              |
| MsgDetails                    | other       | components/safe-messages/MsgDetails/index.tsx                                       | 5              |
| MsgList                       | other       | components/safe-messages/MsgList/index.tsx                                          | 5              |
| ExpandableMsgItem             | other       | components/safe-messages/MsgListItem/ExpandableMsgItem.tsx                          | 5              |
| MsgListItem                   | other       | components/safe-messages/MsgListItem/index.tsx                                      | 5              |
| MsgShareLink                  | other       | components/safe-messages/MsgShareLink/index.tsx                                     | 5              |
| MsgSigners                    | other       | components/safe-messages/MsgSigners/index.tsx                                       | 5              |
| MsgSummary                    | other       | components/safe-messages/MsgSummary/index.tsx                                       | 5              |
| MsgType                       | other       | components/safe-messages/MsgType/index.tsx                                          | 5              |
| PaginatedMsgs                 | other       | components/safe-messages/PaginatedMsgs/index.tsx                                    | 5              |
| SignMsgButton                 | other       | components/safe-messages/SignMsgButton/index.tsx                                    | 5              |
| SingleMsg                     | other       | components/safe-messages/SingleMsg/index.tsx                                        | 5              |
| WalletLogin                   | other       | components/welcome/WelcomeLogin/WalletLogin.tsx                                     | 5              |
...
| FeatureFlagEditorDialogLoader | other       | features/feature-flag-overrides/FeatureFlagEditorDialogLoader.tsx                   | 5              |
| FeatureFlagEditor             | other       | features/feature-flag-overrides/components/FeatureFlagEditor.tsx                    | 5              |
| FeatureFlagEditorDialog       | other       | features/feature-flag-overrides/components/FeatureFlagEditorDialog.tsx              | 5              |
| GRID                          | other       | features/feature-flag-overrides/components/FeatureFlagRow.tsx                       | 5              |
| FeatureFlagSection            | other       | features/feature-flag-overrides/components/FeatureFlagSection.tsx                   | 5              |
| DelegationErrorBoundary       | other       | features/proposers/components/DelegationErrorBoundary.tsx                           | 5              |
| DeleteProposerDialog          | other       | features/proposers/components/DeleteProposerDialog.tsx                              | 5              |
| EditProposerDialog            | other       | features/proposers/components/EditProposerDialog.tsx                                | 5              |
| PendingDelegationsList        | other       | features/proposers/components/PendingDelegationsList.tsx                            | 5              |
| TxProposalChip                | other       | features/proposers/components/TxProposalChip.tsx                                    | 5              |
| UpsertProposer                | other       | features/proposers/components/UpsertProposer.tsx                                    | 5              |
| SafeShieldProvider            | other       | features/safe-shield/SafeShieldContext.tsx                                          | 5              |
| AddressChanges                | other       | features/safe-shield/components/AddressChanges/AddressChanges.tsx                   | 5              |
| AddressImage                  | other       | features/safe-shield/components/AddressImage/AddressImage.tsx                       | 5              |
| AnalysisDetailsDropdown       | other       | features/safe-shield/components/AnalysisDetailsDropdown/AnalysisDetailsDropdown.tsx | 5              |
| AddressPoisoningCardItem      | other       | features/safe-shield/components/AnalysisGroupCard/AddressPoisoningCardItem.tsx      | 5              |
| AnalysisCardItemWithLink      | other       | features/safe-shield/components/AnalysisGroupCard/AnalysisCardItemWithLink.tsx      | 5              |
| AnalysisGroupCardItem         | other       | features/safe-shield/components/AnalysisGroupCard/AnalysisGroupCardItem.tsx         | 5              |
| DelegateCallCardItem          | other       | features/safe-shield/components/AnalysisGroupCard/DelegateCallCardItem.tsx          | 5              |
| FallbackHandlerCardItem       | other       | features/safe-shield/components/AnalysisGroupCard/FallbackHandlerCardItem.tsx       | 5              |
| AnalysisIssuesDisplay         | other       | features/safe-shield/components/AnalysisIssuesDisplay/AnalysisIssuesDisplay.tsx     | 5              |
| HighlightedAddress            | other       | features/safe-shield/components/HighlightedAddress/HighlightedAddress.tsx           | 5              |
| ReportFalseResultModal        | other       | features/safe-shield/components/ReportFalseResultModal/ReportFalseResultModal.tsx   | 5              |
| SafeShieldAnalysisEmpty       | other       | features/safe-shield/components/SafeShieldContent/SafeShieldAnalysisEmpty.tsx       | 5              |
| SafeShieldAnalysisLoading     | other       | features/safe-shield/components/SafeShieldContent/SafeShieldAnalysisLoading.tsx     | 5              |
| SafeShieldContent             | other       | features/safe-shield/components/SafeShieldContent/index.tsx                         | 5              |
| SafeShieldDisplay             | other       | features/safe-shield/components/SafeShieldDisplay.tsx                               | 5              |
| SafeShieldHeader              | other       | features/safe-shield/components/SafeShieldHeader.tsx                                | 5              |
| ShowAllAddress                | other       | features/safe-shield/components/ShowAllAddress/ShowAllAddress.tsx                   | 5              |
| TenderlySimulation            | other       | features/safe-shield/components/TenderlySimulation.tsx                              | 5              |
| AnalysisGroupCardDisabled     | other       | features/safe-shield/components/ThreatAnalysis/AnalysisGroupCardDisabled.tsx        | 5              |
| ThreatAnalysis                | other       | features/safe-shield/components/ThreatAnalysis/ThreatAnalysis.tsx                   | 5              |
| SafeShieldWidget              | other       | features/safe-shield/index.tsx                                                      | 5              |
...
| IndexPage                     | other       | pages/index.tsx                                                                     | 5              |
...
| Appearance                    | settings    | pages/settings/appearance.tsx                                                       | 5              |
...
| PendingDelegation             | other       | features/proposers/components/PendingDelegation.tsx                                 | 3              |
| DecodedMsg                    | other       | components/safe-messages/DecodedMsg/index.tsx                                       | 2              |
| NetworkFee                    | other       | components/new-safe/create/steps/ReviewStep/index.tsx                               | 0              |
| SetAddressStep                | other       | components/new-safe/load/steps/SetAddressStep/index.tsx                             | 0              |
| SanctionWrapper               | other       | components/wrappers/SanctionWrapper/index.tsx                                       | 0              |
| UntrustedSafeWarning          | other       | features/safe-shield/components/UntrustedSafeWarning/index.tsx                      | 0              |
