    ...
    <Theme name={'dark'}>
      <View style={styles.container}>
        ...
        <View style={styles.overlay}>
          <View flex={1}>
            <BlurView
              style={[styles.blurTop, denied && { backgroundColor: 'rgba(0, 0, 0, 1)' }]}
              intensity={30}
                ...
                <View style={{ flex: 1, marginTop: 30, marginLeft: 20, flexDirection: 'row' }}>
                  ...
                  >
                    <Badge
                      ...
                      circleSize="$9"
                      content={<SafeFontIcon size={20} name="close" />}
                    />
                  </Pressable>
                </View>
            ...
            <View style={styles.transparentCenter}>
              <BlurView
                style={[styles.sideBlur, denied && { backgroundColor: 'rgba(0, 0, 0, 1)' }]}
                intensity={30}
                // experimentalBlurMethod={'dimezisBlurView'}
                tint={'systemUltraThinMaterialDark'}
              />
              ...
              <View style={[styles.transparentBox, denied && { backgroundColor: 'rgba(0, 0, 0, 0.8)' }]}>
                ...
                {denied && (
                  <View style={{ flex: 1, justifyContent: 'center', alignItems: 'center' }}>
                    ...
                    <SafeButton rounded secondary onPress={openSettings} marginTop={20}>
                      Enable camera
                    </SafeButton>
                  </View>
                )}
            ...
            {/* Bottom Blur */}
            <BlurView
              style={[styles.blur, denied && { backgroundColor: 'rgba(0, 0, 0, 1)' }]}
              intensity={30}
              // experimentalBlurMethod={'dimezisBlurView'}
              tint={'systemUltraThinMaterialDark'}
            >
