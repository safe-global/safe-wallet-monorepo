...
export function SafeBottomSheet<T>({
  ...
  return (
    <BottomSheet
      ...
      // on iOS, if we don't call router.back() form the backdrop the close animation feels extremely slow
      ...
      backdropComponent={() => <BackdropComponent shouldNavigateBack={Platform.OS === 'ios' ? true : false} />}
