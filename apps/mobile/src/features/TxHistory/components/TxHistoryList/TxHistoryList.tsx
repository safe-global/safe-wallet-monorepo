...
export function TxHistoryList({
  ...
  // Memoize the grouping transformation - critical to avoid recalculation on every render
  // Return stable EMPTY_ARRAY reference when no data to avoid breaking FlashList's empty state
