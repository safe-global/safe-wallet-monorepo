...
import { type Address, createPublicClient, http, WalletClient, EIP1193Provider, Transport, Account, Chain } from 'viem'
...
export async function getSmartAccountClient(client: WalletClient<Transport, Chain | undefined, Account>, safeAddress: Address) {
